...
- `ui` — imports from `application`, `domain`, and `context`
- `context` — imports from `domain`, `application`, `infrastructure`
- `barrel` (index.ts) — imports from `domain`, `application`, `ui`, `context`
